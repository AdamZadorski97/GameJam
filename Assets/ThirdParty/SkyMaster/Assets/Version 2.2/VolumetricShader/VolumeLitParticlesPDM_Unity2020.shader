...
Shader "Particle Dynamic Magic/VolumeLitParticlesPDM_Unity2020" {
	Properties {
    _MainTex ("Particle Texture", 2D) = "white" {}
    _FinalTex ("Final Texture", 2D) = "white" {}
    _InvFade ("Soft Particles Factor", Range(0.01,3.0)) = 1.0
    _Glow ("Glow Factor", Range(0.0,20.0)) = 1.0
    _LightIntensity ("Light Intensity", Range(0.0,55.0)) = 1.0
    _SunLightIntensity ("Sun Intensity", Range(0.0,55.0)) = 1.0
    _MinLight ("Mimize light", Range(-2.0,2.5)) = 0.0
    _SunColor ("Sun Color", Color) = (0,0,0,0)
		ForwLight("Sun dir", Color) = (1,1,1,1)
} 
Category {
        ...
        Pass {    
           ...
           //Blend One One
            ...
            fixed4 frag (v2f i) : SV_Target
            {
               ...
               fixed lerp_vec = max (0, dot (i.normal, ForwLight)	);               
